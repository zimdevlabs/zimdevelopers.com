...
const variants = {
  primary: clsx(
    ...
    'rounded-full border border-transparent bg-zinc-950 shadow-md',
    'text-base font-medium whitespace-nowrap text-white',
    'data-disabled:bg-zinc-950 data-disabled:opacity-40 data-hover:bg-zinc-800',
  ),
  secondary: clsx(
    ...
    'text-base font-medium whitespace-nowrap text-zinc-950',
  ...
  outline: clsx(
    ...
    'text-sm font-medium whitespace-nowrap text-zinc-950',
    'data-disabled:bg-transparent data-disabled:opacity-40 data-hover:bg-zinc-50',
  ),
}
